    ...
    <>
      ...
      <div className="flex">
        <div className="flex rounded-full px-1 py-1 bg-gray-100 md:w-auto w-full">
          ...
          <div onClick={() => setTime('2')} className={ time === '2' ? "rounded-full w-full py-1 md:w-[100px] md:py-2 bg-white font-bold text-zinc-800 text-center cursor-pointer" : "rounded-full w-full py-1 md:w-[100px] md:py-2 text-lightgray-200 text-center cursor-pointer hover:bg-gray-200 transition-colors" }>8-9교시</div>
