                      ...
                      <div key={todo.id} onClick={() => {
                        ...
                        <div>
                          <div className="flex items-center space-x-5">
                            { todo.type === 0 && <div className="w-[50px] h-[50px] flex justify-center overflow-hidden items-center bg-white border-[1px] border-lightgray-100 rounded-[20px]">
                            ...
                            { todo.type === 1 && <div className="w-[50px] h-[50px] bg-gray-100 border-[1px] border-lightgray-100 rounded-[20px] flex items-center justify-center">
                  ...
                  <div key={todo.id}>
                    <StaggerChildrenAnimation>
                      <div key={todo.id} onClick={() => {
                        ...
                        <div className="flex space-x-5 group-hover:opacity-0 absolute right-3 transition-all">
