            ...
            { data.todo.before.length === 0 && search === '' && <div className="my-20">
              <OpacityAnimation>
                <div className="text-lightgray-200 w-full flex items-center justify-center flex-col">
                  ...
                  <div className="mt-1 text-center text-sm md:text-base">다른 구성원에게 보낸 할 일이 없어요<br/>나에게 추가하거나 다른 구성원에게 할 일을 보내보세요</div>
                </div>
              </OpacityAnimation>
            </div> }
            { data.todo.before.length === 0 && search !== '' && <div className="my-20">
            ...
            { data.todo.finished.length === 0 && search === '' && <div className="my-20">
              <OpacityAnimation>
                <div className="text-lightgray-200 w-full flex items-center justify-center flex-col">
                  ...
                  <div className="mt-1 text-center text-sm md:text-base">다른 구성원이 완료한 일이 없어요<br/>모든 구성원들이 해야할 일을 완료하면 이곳에 표시됩니다</div>
                </div>
              </OpacityAnimation>
            </div> }
            { data.todo.finished.length === 0 && search !== '' && <div className="my-20">
