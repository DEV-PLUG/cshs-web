      ...
      <div className="h-[100vh] bg-white w-full md:border-l-[1px] border-lightgray-100 drop-shadow-2xl p-10 overflow-auto">
        <div className="flex justify-between w-full mb-8">
          <div className="flex space-x-7 h-[46px] items-center">
            <div className="font-bold text-3xl text-zinc-800 cursor-pointer">체육대회</div>
          </div>
        </div>
              ...
              <div className="space-y-7">
                <div className="w-full space-y-3">
                  <div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex flex-col">
                        <div className="text-zinc-800 font-bold text-base">오지후</div>
                  ...
                  <div className="space-y-1">
                    <div className="w-[350px] h-[40px] rounded-xl bg-gray-50 border-2 border-gray-200">
                      <div className="w-[200px] h-full rounded-xl bg-gray-100 flex items-center px-3 text-sm text-lightgray-200">축구 유니폼(40%)</div>
                    </div>
                    <div className="w-[350px] h-[40px] rounded-xl bg-emerald-500/20">
                      <div className="w-[250px] h-full rounded-xl bg-emerald-500 flex items-center px-3 text-sm text-white font-bold">하키 유니폼(60%)</div>
                    </div>
                    <div className="text-lightgray-200 text-sm">내일 종료 · 18명 참여</div>
                  </div>
                </div>
              </div>
            </div>
